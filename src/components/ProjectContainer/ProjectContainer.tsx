    ...
    return (
        <div className="w-full min-h-screen flex flex-col px-[110px] gap-10 pb-[50px] max-[1150px]:px-[50px] max-[830px]:px-[40px] max-[500px]:px-[16px]">
            <div className="w-full h-[20vh] flex justify-between items-end max-[500px]:items-start max-[500px]:justify-end">
                <div className="flex flex-col gap-2 max-[500px]:w-[100%]">
                    <h2 className="font-medium text-[calc(1.8rem+0.8vw)] leading-[120%] tracking-[-0.01em]">Projects</h2>
                    <p className="font-medium tetx-[calc(0.45rem+0.8vw)] leading-[140%] tracking-[-0.01em] w-[300px]">As a seasoned creator of contemporary, user-friendly web designs and digital solutions, I aim to assist you in constructing the brand of your fantasies.</p>
                </div>
                <Link to="/projects" className="flex items-center gap-2 font-medium tetx-[calc(0.45rem+0.8vw)] leading-[140%] tracking-[-0.01em] max-[500px]:absolute">More
